...
@Database(entities = [SampleIdeaEntity::class], version = 1)
abstract class SampleIdeaDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context) =
            Room.databaseBuilder(context.applicationContext, SampleIdeaDatabase::class.java, "sampledatabase.db").build()
    }
}